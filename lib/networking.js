...
var session_url = typeof process.env.SESSION_URL !== "undefined" ? process.env.SESSION_URL : "https://api.bortexel.ru/v3/profile/";
var textures_url = typeof process.env.TEXTURES_URL !== "undefined" ? process.env.TEXTURES_URL : "https://textures.minecraft.net/texture/";
...
exp.get_profile = function(rid, uuid, callback) {
  exp.get_from_options(rid, session_url + encodeURIComponent(uuid), { encoding: "utf8" }, function(body, response, err) {
    try {
